...
paste(length(taxaD), 'deep;', length(taxaP), 'shallow')
...
Range sizes are equivalent, with or without subsampling!
```{r}
...
t.test(log(unsampD$meanPairDist), log(unsampP$meanPairDist), alternative='g')
...
t.test(log(rngAvgD$meanPairDist), log(rngAvgP$meanPairDist), alternative='g')
