...
\code{clustr} allows the user to turn off site rarefaction (argument \code{nSite = NULL}), for backwards comparability with its originator publications described above. 
