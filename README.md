...
occurrence data. Three types of subsampling are available to to
standardise the number and maximum spread (dispersion) of sites within a
region of specified size:
...
You can install the development version of divvy from
...
There are two vignettes accompanying the package. To build the vignettes
while downloading the development version, and then view them as
compiled documents, use:
